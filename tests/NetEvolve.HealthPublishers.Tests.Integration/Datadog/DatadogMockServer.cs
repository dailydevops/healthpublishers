...
/// <summary>
/// A minimal, real HTTP listener standing in for the Datadog events intake API, since no
...
/// </summary>
public sealed class DatadogMockServer : IAsyncInitializer, IAsyncDisposable
{
