...
|:-------------|:---------------:|
| [NetEvolve.HealthPublishers.ApplicationInsights](https://www.nuget.org/packages/NetEvolve.HealthPublishers.ApplicationInsights/) <br/><small>Contains an IHealthCheckPublisher implementation that pushes health report results to Azure Application Insights.</small> | [![NuGet Downloads](https://img.shields.io/nuget/dt/NetEvolve.HealthPublishers.ApplicationInsights?logo=nuget&style=for-the-badge)](https://www.nuget.org/packages/NetEvolve.HealthPublishers.ApplicationInsights/#readme-body-tab) |
...
| [NetEvolve.HealthPublishers.Email](https://www.nuget.org/packages/NetEvolve.HealthPublishers.Email/) <br/><small>Contains an IHealthCheckPublisher implementation that sends health report results via SMTP email.</small> | [![NuGet Downloads](https://img.shields.io/nuget/dt/NetEvolve.HealthPublishers.Email?logo=nuget&style=for-the-badge)](https://www.nuget.org/packages/NetEvolve.HealthPublishers.Email/#readme-body-tab) |
| [NetEvolve.HealthPublishers.MicrosoftTeams](https://www.nuget.org/packages/NetEvolve.HealthPublishers.MicrosoftTeams/) <br/><small>Contains an IHealthCheckPublisher implementation that pushes health report results to a Microsoft Teams channel via an incoming webhook or workflow connector.</small> | [![NuGet Downloads](https://img.shields.io/nuget/dt/NetEvolve.HealthPublishers.MicrosoftTeams?logo=nuget&style=for-the-badge)](https://www.nuget.org/packages/NetEvolve.HealthPublishers.MicrosoftTeams/#readme-body-tab) |
